...
6. Navigate your browser to your Anchor installation URL. If you have placed Anchor in a sub directory, make sure you append the directory name to the URL: `http://MYDOMAINNAME.com/anchor`.
